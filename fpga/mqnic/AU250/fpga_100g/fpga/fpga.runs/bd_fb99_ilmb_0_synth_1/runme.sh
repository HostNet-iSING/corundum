...
HD_PWD='/home/ubuntu/git_repos/corundum/fpga/mqnic/AU250/fpga_100g/fpga/fpga.runs/bd_fb99_ilmb_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fb99_ilmb_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_fb99_ilmb_0.tcl
