...
################################################################
# This is a generated script based on design: cms
#
...
proc create_root_design { parentCell } {
  ...
  set interrupt_host_0 [ create_bd_port -dir O -type intr interrupt_host_0 ]
  ...
  connect_bd_net -net cms_subsystem_0_interrupt_host [get_bd_ports interrupt_host_0] [get_bd_pins cms_subsystem_0/interrupt_host]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces s_axi_ctrl_0] [get_bd_addr_segs cms_subsystem_0/s_axi_ctrl/Mem0] -force
