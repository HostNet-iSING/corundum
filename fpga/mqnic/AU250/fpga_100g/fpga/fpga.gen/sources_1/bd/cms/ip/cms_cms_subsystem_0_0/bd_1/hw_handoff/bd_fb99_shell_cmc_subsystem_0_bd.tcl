...
################################################################
# This is a generated script based on design: bd_43c9
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./fpga.gen/sources_1/bd/cms/ip/cms_cms_subsystem_0_0/bd_1
...
proc create_hier_cell_reset_gen { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_reset_gen() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_qsfp_gpio_hierarchy { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_qsfp_gpio_hierarchy() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  set interrupt_hbm_cattrip [ create_bd_port -dir I -from 0 -to 0 -type intr interrupt_hbm_cattrip ]
  set_property -dict [ list \
   CONFIG.PortWidth {1} \
  ...
  # Create instance: HBM_Temp_Sensor_Enable, and set properties
  set HBM_Temp_Sensor_Enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 HBM_Temp_Sensor_Enable ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $HBM_Temp_Sensor_Enable

  # Create instance: QSFP_Write_Enable, and set properties
  set QSFP_Write_Enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 QSFP_Write_Enable ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
 ] $QSFP_Write_Enable

  # Create instance: Reserved_3, and set properties
  set Reserved_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Reserved_3 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $Reserved_3

  # Create instance: Reserved_4, and set properties
  set Reserved_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Reserved_4 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $Reserved_4

  # Create instance: Reserved_5, and set properties
  set Reserved_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Reserved_5 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $Reserved_5

  # Create instance: Reserved_6, and set properties
  set Reserved_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Reserved_6 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $Reserved_6

  # Create instance: Reserved_7, and set properties
  set Reserved_7 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Reserved_7 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $Reserved_7

  # Create instance: VCCInt_Scaling_Enable, and set properties
  set VCCInt_Scaling_Enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 VCCInt_Scaling_Enable ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
 ] $VCCInt_Scaling_Enable
  ...
  # Create instance: axi_gpio_cms_features, and set properties
  set axi_gpio_cms_features [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_cms_features ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
   CONFIG.C_GPIO_WIDTH {8} \
 ] $axi_gpio_cms_features
  ...
  set axi_intc_cmc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 axi_intc_cmc ]
  set_property -dict [ list \
   CONFIG.C_ASYNC_INTR {0x0000800F} \
   CONFIG.C_ENABLE_ASYNC {0} \
   CONFIG.C_HAS_FAST {1} \
   CONFIG.C_KIND_OF_EDGE {0xFFFFFFFF} \
   CONFIG.C_KIND_OF_INTR {0x0000024F} \
  ...
  # Create instance: build_info_cmc, and set properties
  set build_info_cmc [ create_bd_cell -type ip -vlnv xilinx.com:ip:shell_utils_build_info:1.0 build_info_cmc ]
  set_property -dict [ list \
   CONFIG.C_CORE_REVISION {0} \
   CONFIG.C_MAJOR_VERSION {2} \
   CONFIG.C_MINOR_VERSION {2} \
   CONFIG.C_PATCH_REVISION {0} \
   CONFIG.C_PERFORCE_CL {3246043} \
   CONFIG.C_RESERVED_TAG {0x00000000} \
   CONFIG.C_SUBSYSTEM_ID {0x02} \
   CONFIG.C_VIV_VERSION {0x202110} \
 ] $build_info_cmc

  # Create instance: build_info_host, and set properties
  set build_info_host [ create_bd_cell -type ip -vlnv xilinx.com:ip:shell_utils_build_info:1.0 build_info_host ]
  set_property -dict [ list \
   CONFIG.C_CORE_REVISION {0} \
   CONFIG.C_MAJOR_VERSION {2} \
   CONFIG.C_MINOR_VERSION {2} \
  ...
  # Create instance: cms_feature_concat, and set properties
  set cms_feature_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 cms_feature_concat ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $cms_feature_concat
  ...
  connect_bd_intf_net -intf_net axi_ic_cmc_local_M14_AXI [get_bd_intf_pins axi_gpio_cms_features/S_AXI] [get_bd_intf_pins axi_ic_cmc_local/M14_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ic_mgmt_M04_AXI [get_bd_intf_pins axi_ic_mgmt/M04_AXI] [get_bd_intf_pins build_info_host/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net HBM_Temp_Sensor_Enable_dout [get_bd_pins HBM_Temp_Sensor_Enable/dout] [get_bd_pins cms_feature_concat/In1]
  connect_bd_net -net QSFP_Write_Enable_dout [get_bd_pins QSFP_Write_Enable/dout] [get_bd_pins cms_feature_concat/In0]
  connect_bd_net -net Reserved_3_dout [get_bd_pins Reserved_3/dout] [get_bd_pins cms_feature_concat/In3]
  connect_bd_net -net Reserved_4_dout [get_bd_pins Reserved_4/dout] [get_bd_pins cms_feature_concat/In4]
  connect_bd_net -net Reserved_5_dout [get_bd_pins Reserved_5/dout] [get_bd_pins cms_feature_concat/In5]
  connect_bd_net -net Reserved_6_dout [get_bd_pins Reserved_6/dout] [get_bd_pins cms_feature_concat/In6]
  connect_bd_net -net Reserved_7_dout [get_bd_pins Reserved_7/dout] [get_bd_pins cms_feature_concat/In7]
  connect_bd_net -net VCCInt_Scaling_Enable_dout [get_bd_pins VCCInt_Scaling_Enable/dout] [get_bd_pins cms_feature_concat/In2]
  connect_bd_net -net aclk_ctrl_net [get_bd_ports aclk_ctrl] [get_bd_pins axi_bram_ctrl_firmware/s_axi_aclk] [get_bd_pins axi_bram_ctrl_regmap_cmc/s_axi_aclk] [get_bd_pins axi_bram_ctrl_regmap_host/s_axi_aclk] [get_bd_pins axi_gpio_cmc_mb_rst_n/s_axi_aclk] [get_bd_pins axi_gpio_cms_features/s_axi_aclk] [get_bd_pins axi_gpio_hbm_temp/s_axi_aclk] [get_bd_pins axi_gpio_mb_intr/s_axi_aclk] [get_bd_pins axi_gpio_mutex_cmc/s_axi_aclk] [get_bd_pins axi_gpio_mutex_host/s_axi_aclk] [get_bd_pins axi_gpio_timebase/s_axi_aclk] [get_bd_pins axi_gpio_wdt/s_axi_aclk] [get_bd_pins axi_ic_cmc_local/ACLK] [get_bd_pins axi_ic_cmc_local/M00_ACLK] [get_bd_pins axi_ic_cmc_local/M01_ACLK] [get_bd_pins axi_ic_cmc_local/M02_ACLK] [get_bd_pins axi_ic_cmc_local/M03_ACLK] [get_bd_pins axi_ic_cmc_local/M04_ACLK] [get_bd_pins axi_ic_cmc_local/M05_ACLK] [get_bd_pins axi_ic_cmc_local/M06_ACLK] [get_bd_pins axi_ic_cmc_local/M07_ACLK] [get_bd_pins axi_ic_cmc_local/M08_ACLK] [get_bd_pins axi_ic_cmc_local/M09_ACLK] [get_bd_pins axi_ic_cmc_local/M10_ACLK] [get_bd_pins axi_ic_cmc_local/M11_ACLK] [get_bd_pins axi_ic_cmc_local/M12_ACLK] [get_bd_pins axi_ic_cmc_local/M13_ACLK] [get_bd_pins axi_ic_cmc_local/M14_ACLK] [get_bd_pins axi_ic_cmc_local/S00_ACLK] [get_bd_pins axi_ic_mgmt/ACLK] [get_bd_pins axi_ic_mgmt/M00_ACLK] [get_bd_pins axi_ic_mgmt/M01_ACLK] [get_bd_pins axi_ic_mgmt/M02_ACLK] [get_bd_pins axi_ic_mgmt/M03_ACLK] [get_bd_pins axi_ic_mgmt/M04_ACLK] [get_bd_pins axi_ic_mgmt/M05_ACLK] [get_bd_pins axi_ic_mgmt/S00_ACLK] [get_bd_pins axi_intc_cmc/processor_clk] [get_bd_pins axi_intc_cmc/s_axi_aclk] [get_bd_pins axi_intc_host/s_axi_aclk] [get_bd_pins axi_timebase_wdt/s_axi_aclk] [get_bd_pins axi_uartlite_satellite/s_axi_aclk] [get_bd_pins axi_uartlite_usb/s_axi_aclk] [get_bd_pins build_info_cmc/S_AXI_ACLK] [get_bd_pins build_info_host/S_AXI_ACLK] [get_bd_pins freerun_counter/CLK] [get_bd_pins microblaze_axi_vip/aclk] [get_bd_pins microblaze_cmc/Clk] [get_bd_pins microblaze_local_memory/clk] [get_bd_pins msp432_bsl_crc_gen/clk] [get_bd_pins psreset_cmc/slowest_sync_clk] [get_bd_pins qsfp_gpio_hierarchy/aclk_ctrl] [get_bd_pins reachout_axi_vip/aclk]
  connect_bd_net -net aresetn_ctrl_net [get_bd_ports aresetn_ctrl] [get_bd_pins axi_bram_ctrl_firmware/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_regmap_host/s_axi_aresetn] [get_bd_pins axi_gpio_cmc_mb_rst_n/s_axi_aresetn] [get_bd_pins axi_gpio_cms_features/s_axi_aresetn] [get_bd_pins axi_gpio_mutex_host/s_axi_aresetn] [get_bd_pins axi_ic_mgmt/ARESETN] [get_bd_pins axi_ic_mgmt/M00_ARESETN] [get_bd_pins axi_ic_mgmt/M01_ARESETN] [get_bd_pins axi_ic_mgmt/M02_ARESETN] [get_bd_pins axi_ic_mgmt/M03_ARESETN] [get_bd_pins axi_ic_mgmt/M04_ARESETN] [get_bd_pins axi_ic_mgmt/M05_ARESETN] [get_bd_pins axi_ic_mgmt/S00_ARESETN] [get_bd_pins axi_intc_host/s_axi_aresetn] [get_bd_pins build_info_host/S_AXI_ARESETN] [get_bd_pins psreset_cmc/ext_reset_in]
  ...
  connect_bd_net -net axi_timebase_wdt_wdt_interrupt [get_bd_pins axi_timebase_wdt/wdt_interrupt] [get_bd_pins concat_intr_cmc/In8]
  connect_bd_net -net axi_uartlite_satellite_interrupt [get_bd_pins axi_uartlite_satellite/interrupt] [get_bd_pins concat_intr_cmc/In3]
  connect_bd_net -net axi_uartlite_usb_interrupt [get_bd_pins axi_uartlite_usb/interrupt] [get_bd_pins concat_intr_cmc/In6]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins axi_gpio_timebase/gpio_io_i] [get_bd_pins freerun_counter/Q]
  connect_bd_net -net cmc_mb_rst [get_bd_pins axi_intc_cmc/processor_rst] [get_bd_pins microblaze_cmc/Reset] [get_bd_pins psreset_cmc/mb_reset]
  connect_bd_net -net cms_feature_concat_dout [get_bd_pins axi_gpio_cms_features/gpio_io_i] [get_bd_pins cms_feature_concat/dout]
  ...
  connect_bd_net -net gnd_bus_1_interrupt_dout [get_bd_pins concat_intr_cmc/In1] [get_bd_pins concat_intr_cmc/In2] [get_bd_pins concat_intr_cmc/In4] [get_bd_pins concat_intr_cmc/In5] [get_bd_pins concat_intr_cmc/In9] [get_bd_pins concat_intr_cmc/In10] [get_bd_pins concat_intr_cmc/In11] [get_bd_pins concat_intr_cmc/In13] [get_bd_pins gnd_bus_1_interrupts/dout]
  ...
  connect_bd_net -net interrupt_hbm_cattrip_1 [get_bd_ports interrupt_hbm_cattrip] [get_bd_pins concat_intr_cmc/In12]
  ...
  assign_bd_address -offset 0x01FD0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_cmc/Data] [get_bd_addr_segs axi_gpio_cms_features/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x01F50000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_cmc/Data] [get_bd_addr_segs axi_intc_cmc/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x01F80000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_cmc/Data] [get_bd_addr_segs axi_uartlite_usb/S_AXI/Reg] -force
  assign_bd_address -offset 0x01F00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_cmc/Data] [get_bd_addr_segs build_info_cmc/S_AXI/reg0] -force
  assign_bd_address -offset 0xF0000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces microblaze_cmc/Data] [get_bd_addr_segs microblaze_local_memory/lmb_bram_if_cntlr/SLMB/Mem] -force
  assign_bd_address -offset 0xF0000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces microblaze_cmc/Instruction] [get_bd_addr_segs microblaze_local_memory/lmb_bram_if_cntlr/SLMB1/Mem] -force
  assign_bd_address -offset 0x00000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces s_axi_ctrl_mgmt] [get_bd_addr_segs axi_bram_ctrl_firmware/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x0002A000 -range 0x00001000 -target_address_space [get_bd_addr_spaces s_axi_ctrl_mgmt] [get_bd_addr_segs build_info_host/S_AXI/reg0] -force
